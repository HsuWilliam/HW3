...
class cnnlistAdapter(val context: Context,private val listener : OnItemClickListener):RecyclerView.Adapter<cnnlistAdapter.ViewHolder>(){
    ...
    inner class ViewHolder(val binding:YoutubeListItemBinding):RecyclerView.ViewHolder(binding.root),View.OnClickListener {
